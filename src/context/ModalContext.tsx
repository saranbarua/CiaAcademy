...
export const ModalProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [advisorCourseName, setAdvisorCourseName] = useState<string | undefined>(undefined);

  const [isBrochureModalOpen, setIsBrochureModalOpen] = useState(false);
  const [brochureCourseName, setBrochureCourseName] = useState<string | undefined>(undefined);
