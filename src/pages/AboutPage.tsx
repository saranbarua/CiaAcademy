...
export const AboutPage: React.FC = () => {
  ...
  const values = [
    {
      ...
      description: 'We uphold strict Ofqual and SIA quality benchmarks, ensuring genuine assessment integrity and accredited recognition across the UK.',
      icon: ShieldCheck
    },
    {
      title: 'Practical Career Readiness',
      description: 'Our curriculum goes beyond textbook theory to include real equipment handling, emergency scenario simulations, and employer workshops.',
      icon: Target
    },
    {
      title: 'Global Inclusivity & Support',
      description: 'We celebrate a diverse student community representing over 40 nationalities with dedicated visa, housing, and pastoral guidance.',
      icon: Users
    },
    {
      title: 'Empowerment & Progression',
      description: 'From entry-level licence training to full Bachelor/Master degrees, we provide accessible laddered qualification pathways.',
      icon: Award
    }
  ];
  ...
  const faculty = [
    ...
    },
    {
      ...
      credentials: 'MA Applied Linguistics (UCL), Certified British Council Trainer',
  ...
  return (
    <>
      <SEOHead
        title="About Apex Academy | Leading UK Accredited Training & Higher Education"
        description="Learn about Apex Academy's mission, Ofqual accreditation, central London campus facilities, and experienced academic faculty."
        keywords="about Apex Academy, UK education academy, Ofqual accredited training centre London, SIA training provider"
        canonicalUrl="https://apexacademy.ac.uk/about"
      />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-7 space-y-6">
                ...
                <p className="text-base sm:text-lg text-slate-300 leading-relaxed">
                  Founded in London with a vision to make regulated British qualifications accessible, rigorous, and career-transforming, Apex Academy has trained over 5,000 students and professionals.
                </p>
              ...
              <div className="lg:col-span-5">
                <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-slate-800 bg-slate-900 aspect-[4/3.5]">
                  <img
                    ...
                    alt="Apex Academy Lecture Theatre"
                  ...
                  <div className="absolute bottom-4 left-4 right-4 p-3.5 rounded-2xl bg-slate-900/90 backdrop-blur-md border border-slate-700 text-xs">
                    <p className="font-bold text-white">Central London Campus</p>
                    <p className="text-slate-400">45 Commercial Road, London E1 1LA</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="p-8 rounded-3xl bg-indigo-50/60 dark:bg-slate-800/80 border border-indigo-100 dark:border-slate-700 space-y-4">
                ...
                <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 leading-relaxed">
                  To deliver highest-standard, career-focused, and regulated vocational and higher education qualifications that equip individuals with practical mastery, legal compliance, and long-term career mobility.
                </p>
              </div>
              ...
              <div className="p-8 rounded-3xl bg-cyan-50/60 dark:bg-slate-800/80 border border-cyan-100 dark:border-slate-700 space-y-4">
                ...
                <p className="text-sm sm:text-base text-slate-600 dark:text-slate-300 leading-relaxed">
                  To be the UK's most trusted gateway for professional licencing and international university progression, recognised globally for academic excellence, ethical admissions, and student outcome benchmarks.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-2xl mx-auto mb-14">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300 mt-2">
                Our tutors bring decades of frontline UK field experience, PhD scholarship, and official examining credentials.
              </p>
            </div>
