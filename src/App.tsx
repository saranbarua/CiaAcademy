...
import { TraineeAuthProvider } from "./context/TraineeAuthContext";
          ...
          <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-[#0B0F19] text-slate-900 dark:text-slate-100 font-sans antialiased selection:bg-indigo-500 selection:text-white transition-colors duration-200 relative overflow-x-hidden">
            ...
            <main className="flex-grow">
              <Routes>
                ...
                {/* Trainee auth */}
                <Route path="/login" element={<TraineeLoginPage />} />
                <Route path="/register" element={<TraineeRegisterPage />} />

                {/* Protected trainee routes */}
                <Route
                  path="/apply"
                  element={
                    <ProtectedTraineeRoute>
                      <ApplyPage />
                    </ProtectedTraineeRoute>
                  }
                />
